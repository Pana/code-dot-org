...
/**
 * Returns a list of sprites, specified by id, name, or animation name.
 * @param {object} spriteArg - Specifies the id, name, or animation name of the desired sprite(s).
